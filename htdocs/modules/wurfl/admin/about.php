...
$donationform = array(
    ...
    1   => '<table class="outer" cellspacing="1" width="100%"><tbody><tr><th colspan="2">'
           . constant('_WURFL_AM_ABOUT_MAKEDONATE')
...
for ($key = 0; $key <= 4; $key++) {
    switch ($key) {
        case 2:
            $donationform[$key] = sprintf($donationform[$key], $GLOBALS['xoopsConfig']['sitename'] . ' - ' . (strlen($GLOBALS['xoopsUser']->getVar('name')) > 0 ? $GLOBALS['xoopsUser']->getVar('name')
                                                                                                                                                                  . ' ['
                                                                                                                                                                  . $GLOBALS['xoopsUser']->getVar('uname')
                                                                                                                                                                  . ']' : $GLOBALS['xoopsUser']->getVar('uname')),
                                          $GLOBALS['xoopsUser']->getVar('email'), XOOPS_LICENSE_KEY, strtoupper($GLOBALS['wurflModule']->getVar('dirname')),
                                          strtoupper($GLOBALS['wurflModule']->getVar('dirname')) . ' ' . $GLOBALS['wurflModule']->getVar('name'));
            break;
    }
}
