...
switch ($GLOBALS['fct']) {
    ...
    case 'new':
        ...
        if ($handler->insert($object)) {
            redirect_header('devices.php?limit='
                            . $_REQUEST['limit']
                            . "&start="
                            . $_REQUEST['start']
                            . "&sort="
                            ...
                            . $_REQUEST['order']
                            . "&filter="
                            . $_REQUEST['filter'], 10, _WURFL_AM_MSG_CREATEWENTOK);
        } else {
            redirect_header('devices.php?limit='
                            . $_REQUEST['limit']
                            . "&start="
                            ...
                            . $_REQUEST['order']
                            . "&filter="
                            . $_REQUEST['filter'], 10, _WURFL_AM_MSG_CREATEFAILED);
        }
        exit;
    case 'save':
        $object = $handler->get($_REQUEST['did']);
        ...
        if ($handler->insert($object)) {
            redirect_header('devices.php?limit='
                            ...
                            . $_REQUEST['order']
                            . "&filter="
                            . $_REQUEST['filter'], 10, _WURFL_AM_MSG_SAVEWENTOK);
        } else {
            redirect_header('devices.php?limit='
                            . $_REQUEST['limit']
                            . "&start="
                            ...
                            . $_REQUEST['order']
                            . "&filter="
                            . $_REQUEST['filter'], 10, _WURFL_AM_MSG_SAVEFAILED);
        }
        exit;
}
