 ...
 * @package   kernel
 */
class WurflPlayback extends XoopsObject
{
 ...
 * @package kernel
 */
class WurflPlaybackHandler extends XoopsPersistableObjectHandler
{
    public function __construct($db)
    {
        $this->db = $db;
        parent::__construct($db, "wurfl_devices_playback", 'WurflPlayback', 'did');
    }
}
