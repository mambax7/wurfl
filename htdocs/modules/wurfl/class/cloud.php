...
include_once(dirname(__FILE__).'/Cache/CacheInterface.php');
include_once(dirname(__FILE__).'/Cache/Cookie.php');
include_once(dirname(__FILE__).'/Cache/Null.php');
include_once(dirname(__FILE__).'/Cache/Xoopscache.php');
include_once(dirname(__FILE__).'/Client/Client.php');
include_once(dirname(__FILE__).'/Client/Config.php');
include_once(dirname(__FILE__).'/Client/Exception.php');
include_once(dirname(__FILE__).'/HttpClient/AbstractHttpClient.php');
include_once(dirname(__FILE__).'/HttpClient/Curl.php');
include_once(dirname(__FILE__).'/HttpClient/Factory.php');
include_once(dirname(__FILE__).'/HttpClient/Fsock.php');
...
class WurflCloudHandler extends XoopsPersistableObjectHandler
{
	...
	function testUserAgentForTheme(){
    ...
    function testUserAgent($as_array = false){
    	$this->errors[] = array();
		try {
