 ...
 * @package kernel
 */
class WurflTranscoding extends XoopsObject
{
...
* @package kernel
*/
class WurflTranscodingHandler extends XoopsPersistableObjectHandler
{
    function __construct(&$db) 
    {
		$this->db = $db;
        parent::__construct($db, "wurfl_devices_transcoding", 'WurflTranscoding', 'did');
    }
}
